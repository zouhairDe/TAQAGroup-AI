...
const Alert: React.FC<AlertProps> = ({
  ...
  return (
    <div
      className={cn(
        "rounded-xl border p-6 relative shadow-theme-sm",
          ...
          <div className="flex items-start justify-between">
            <div className="flex-1">
              ...
              {showLink && (
                <Link
                  href={linkHref}
                  className="inline-block mt-4 text-sm font-medium text-taqa-electric-blue hover:text-taqa-navy dark:text-taqa-electric-blue dark:hover:text-taqa-navy underline"
                >
                  {linkText}
                </Link>
              )}
